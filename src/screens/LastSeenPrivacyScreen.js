...
const LastSeenPrivacyScreen = ({ navigation, route }) => {
  ...
  const privacyOptions = [
    ...
    },
    {
      id: 'contacts',
      label: 'My Contacts',
      description: 'Only contacts in your address book can see your last seen',
    },
    {
      id: 'nobody',
      label: 'Nobody',
      description: 'No one can see your last seen',
    },
  ];

  const handleSave = () => {
    navigation.navigate('Profile', { updatedLastSeen: selectedOption });
  };
